...
Because there is no lecture next week, there is a batch of exercises to be done this week:
...
Run the code below to install and load the libararies needed for this exercise, as well as the dataset. Then, load the data
...
3. What is the mean age in the population?
