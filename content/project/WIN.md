...
As part of our work, we have developed our own open-source smartphone app. The app works cross-platform, and is used to collect data on travel, budget expenditure, and time use.
...
##Outputs:
The project has resulted in about 40 different publications. Direct links to the publications, syntax etc. of products where I was an author [can be found here](https://www.peterlugtig.com/tags/CBS/)
