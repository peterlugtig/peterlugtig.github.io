...
#### Week 1: Introduction to Survey Research - Two modes of inference
...
**Take home Exercise:** adopt a survey. Every student will adopt one survey (from a longlist). Every survey comes with documentation on the survey design, as well as survey dataset. on this in weeks 1-6), and then correct for unit- and item nonresponse for this survey. 
...
#### Week 2: Total Survey Error and survey modes
...
#### Week 3: Sampling 1: simple random sampling	
...
#### Week 4: Sampling 2: stratification and clustering
...
#### Week 5: Using R for analyzing survey datasets
...
#### Week 6: Model-assisted survey estimation
...
Exercise in class: Discussion on situations it is idea to use ratio/regression estimation?

**Take home exercise (for week 44):** TBA.

#### Week 7: Class-free Week. 

Catch up on readings and exercises. Review parts of lectures/exercises again that you found difficult.

--- 

#### Week 8: Nonresponse and weighting
...
#### Week 12: Survey modes: design and estimation 
...
#### Week 13: Inference for non-probability surveys 
...
**After the lecture:** You have the opportunity to also hand in a draft of your report by 13 December at 17:00 latest. You will then receive written feedback on what can be improved before Monday 20 December 17:00. It is not obligatory to hand in a draft version.
